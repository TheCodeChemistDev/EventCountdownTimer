...
class TimerAdapter(private val timers: List<Timer>) : RecyclerView.Adapter<TimerAdapter.TimerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TimerViewHolder, position: Int) {
        ...
        val eventDateTime = sdf.parse(day + "/" + month + "/" + year + " " + hour + ":" + minute)
        ...
        val currentDateTime = sdf.parse(Integer.toString(currentDay) + "/" + currentMonth + "/" + currentYear + " " + currentHour + ":" + currentMinute)
        ...
        val daysDiff = timeDiffInSecs / 86400
        val hoursDiff = (timeDiffInSecs % 86400) / 3600
        val minutesDiff = ((timeDiffInSecs % 86400) % 3600) / 60
        val secondsDiff = ((timeDiffInSecs % 86400) % 3600) % 60
